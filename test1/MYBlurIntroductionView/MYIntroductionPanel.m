...
-(id)initWithFrame:(CGRect)frame nibNamed:(NSString *)nibName description:(NSString *)description image:(UIImage *)image
{
    self = [super init];
    if (self) {
        // Initialization code
        ...
        //self.message.font = [UIFont fontWithName:@"-" size:20];
        self.message.font = [UIFont boldSystemFontOfSize:20];
...
-(void)buildPanelWithFrame:(CGRect)frame{
    ...
    //Create title label
    self.PanelTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(kLeftRightMargins, runningYOffset, frame.size.width - 1*kLeftRightMargins, panelTitleHeight)];
    self.PanelTitleLabel.numberOfLines = 0;
    self.PanelTitleLabel.text = self.PanelTitle;
//    self.PanelTitleLabel.font = [UIFont fontWithName:@"-" size:15];
    self.PanelTitleLabel.font = [UIFont boldSystemFontOfSize:15];
    ...
    self.PanelDescriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(kLeftRightMargins, runningYOffset, frame.size.width - 1*kLeftRightMargins, panelDescriptionHeight+10)];
    self.PanelDescriptionLabel.numberOfLines = 0;
    self.PanelDescriptionLabel.text = self.PanelDescription;
//    self.PanelDescriptionLabel.font = [UIFont fontWithName:@"-" size:15];
    self.PanelDescriptionLabel.font = [UIFont boldSystemFontOfSize:15];
